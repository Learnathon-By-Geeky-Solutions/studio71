...
namespace sniperAI
{
    ...
    {
        // Inspector Settings
        public float optimalRange{ get; private set; } = 30f;
        public float aimTime { get; private set; }= 2f;
        public float detectionRadius { get; private set; }= 20f;
        public float fleeDistance { get; private set; } = 15f;
        public Vector3[] repositionPoints { get; private set; } = new Vector3[2];
        public float shotDamage { get; private set; } = 50f;
