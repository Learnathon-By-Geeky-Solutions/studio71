    ...
    public void Enter()
    {
        ...
        else
        {
            ...
            if (enemy.player != null)
            {
                ...
                Vector3 retreatPosition = enemy.transform.position + directionAway.normalized * enemy.detectionRange * 0.5f;
                
                if (UnityEngine.AI.NavMesh.SamplePosition(retreatPosition, out UnityEngine.AI.NavMeshHit hit, 10f, UnityEngine.AI.NavMesh.AllAreas))
                {
